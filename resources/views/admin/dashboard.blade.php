                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">{{$data['pembayarans']}}</h6>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">{{$data['orders']}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">{{$data['venue']}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">{{$data['customers']}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="{{asset('/assets/admin/admintl/assets/compiled/jpg/1.jpg')}}" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">{{ $user->name }}</h5>
                                        <a type="button" class="btn btn-primary" href="/adminprofile">Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                               ...
                               <div class="table">
                                ...
                                <div class="tbody">
                                    @foreach ($data['order'] as $order)
                                            <div class="name ms-4 mb-2">
                                                <h5 class="mb-1">{{ $order->id_pemesanan }}</h5>
                                                <h6 class="text-muted mb-0">{{ number_format($order->total_biaya, 0, ',', '.') }} </h6>
                                            </div>
                                            {{-- <hr> --}}
                                        @endforeach
                                </div>
                                ...
                                <div class="px-4">
                                    ...
                                    <a href ="pendingorder" class='btn btn-block btn-xl btn-outline-primary font-bold mt-3'>Lihat Semua</a>
                                </div>
                            </div>
                        </div> 
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($data['testimoni'] as $testimoni)
                                            <tr>
                                                ...
                                                <td>{{$testimoni->id_pemesanan}}</td>
                                                <td>{{$testimoni->id_customer}}</td>
...
<!-- Need: Apexcharts -->
<script src="{{asset('/assets/admin/admintl/assets/extensions/apexcharts/apexcharts.min.js')}}"></script>
<script src="{{asset('/assets/admin/admintl/assets/static/js/pages/dashboard.js')}}"></script>
