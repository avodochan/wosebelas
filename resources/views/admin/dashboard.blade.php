                                ...
                                <div class="col-7">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="{{asset('/assets/admin/admintl/assets/static/images/bootstrap-icons.svg#circle-fill')}}" />
                                        </svg>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{asset('/assets/admin/admintl/assets/compiled/jpg/5.jpg')}}">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{asset('/assets/admin/admintl/assets/compiled/jpg/2.jpg')}}">
                                                    </div>
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{asset('/assets/admin/admintl/assets/compiled/jpg/4.jpg')}}">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{asset('/assets/admin/admintl/assets/compiled/jpg/1.jpg')}}">
                        </div>
                        <div class="name ms-4">
