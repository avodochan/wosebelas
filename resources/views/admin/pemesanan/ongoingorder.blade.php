                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Ongoing Order</h3>
                            <p class="text-subtitle text-muted">Order yang sedang berlangsung akan tampil disini</p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-group">
                                                    ...
                                                    <form action="{{ route('admin.orders.updateOngoing', ['id' => $order->id_pemesanan]) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('PUT')
