                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tambah Item Main Course</h4>
                                <hr>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('itemmaincourse.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">Nama Item Maincourse</label>
                                                <input type="text" class="form-control"
                                                    name="nama_item_maincourse">
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-12 col-12">
                                            <div class="form-group mb-3">
                                                <label for="first-name-column">Deskripsi Item Maincourse</label>
                                                <textarea class="form-control" rows="3" name="deskripsi_item_maincourse"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select" name="kategori_item_maincourse">
                                                        <option value disabled></option>
                                                        <option value="karbohidrat">Karbohidrat</option>
                                                        <option value="lauk pauk">Lauk Pauk</option>
                                                        <option value="tumisan">Tumisan</option>
