                ...
                <div class="row match-height">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('dekorasi.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group mb-3">
                                                <label for="first-name-column">Deskripsi Dekorasi</label>
                                                <textarea class="form-control" rows="3" name="deskripsi_dekorasi"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="city-column">Harga Dekorasi</label>
